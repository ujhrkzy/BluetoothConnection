...
public class OscUI extends JPanel {
    ...
    protected JButton firstSynthButtonOn, secondSynthButtonOn,
            thirdSynthButtonOn;
    protected JButton firstSynthButtonOff, secondSynthButtonOff,
            thirdSynthButtonOff;
    ...
    protected void addOscServerAddressPanel() {
        ...
        // as the text
        // it looks like OSCPortOut has a method to get the default
        // SuperCollider port
        JLabel portWidget = new JLabel(Integer.toString(OSCPort
                .defaultSCOSCPort()));
    ...
    protected void addSecondSynthPanel() {
        ...
        textBox2.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                slider2.setValue((int) (10000 * Math
                        .sqrt(((freq - 20) / 10000))));
                doSendSlider(freq, 1001);
            }
        });
    ...
    protected void addThirdSynthPanel() {
        ...
        textBox3.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                slider3.setValue((int) (10000 * Math
                        .sqrt(((freq - 20) / 10000))));
                doSendSlider(freq, 1002);
            }
        });
    ...
    public void addressChanged() {
        // the variable OSCPortOut tries to get an instance of OSCPortOut at the
        // address
        // indicated by the addressWidget
        try {
            oscPort = new OSCPortOut(InetAddress.getByName(addressWidget
                    .getText()));
    ...
    public void doSendOn(float freq, int node) {
        ...
        Object[] args = { "javaosc-example", new Integer(node), new Integer(1),
                new Integer(0), "freq", new Float(freq) };
        // a comma is placed after /s_new in the code
        OSCMessage msg = null;// new OSCMessage("/s_new", args);
    ...
    public void doSendOff(int node) {
        ...
        OSCMessage msg = null;// new OSCMessage("/n_free", args);
    ...
    public void doSendSlider(float freq, int node) {
        ...
        OSCMessage msg = null;// new OSCMessage("/n_set", args);
    ...
    public void doSendGlobalOff(int node1, int node2, int node3) {
        ...
        OSCMessage msg1 = null;// new OSCMessage("/n_free", args1);

        Object[] args2 = { new Integer(node2) };
        OSCMessage msg2 = null;// new OSCMessage("/n_free", args2);

        Object[] args3 = { new Integer(node3) };
        OSCMessage msg3 = null;// new OSCMessage("/n_free", args3);
        ...
        OSCBundle bundle = null;// //new OSCBundle(packets, newDate);
    ...
    public void doSendGlobalOn(int node1, int node2, int node3) {
        ...
        OSCMessage msg1 = null;// new OSCMessage("/s_new", args1);

        Object[] args2 = { "javaosc-example", new Integer(node2),
                new Integer(1), new Integer(0) };
        OSCMessage msg2 = null;// new OSCMessage("/s_new", args2);

        Object[] args3 = { "javaosc-example", new Integer(node3),
                new Integer(1), new Integer(0) };
        OSCMessage msg3 = null;// new OSCMessage("/s_new", args3);
